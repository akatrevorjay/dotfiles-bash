...
# Auto-completion
# ---------------
[[ $- == *i* ]] && source "/Users/trevorj/.shell/zsh-plugged/repos/junegunn/fzf/shell/completion.bash" 2> /dev/null

# Key bindings
# ------------
source "/Users/trevorj/.shell/zsh-plugged/repos/junegunn/fzf/shell/key-bindings.bash"
